...
│
├── notebooks/
│   ├── 01_cleaning_listing_data.ipynb   
│   ├── 02_cleaning_reviews_data.ipynb   
│   ├── 03_cleaning_calendar_data.ipynb  
│   ├── 04_feature_engineering.ipynb     
│   ├── 05_ml_pipeline.ipynb             
│   ├── 06_ml_encoding.ipynb             
│   └── 07_plots.ipynb                   
│
├── plots/
│   ├── 01_price_distribution.png        
│   ├── 02_price_by_borough.png          
│   ├── 03_price_by_room_type.png        
│   ├── 04_price_map.png                 
│   ├── 05_correlation_heatmap.png       
│   ├── actual_vs_predicted_tuned.png    
